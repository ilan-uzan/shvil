...
class PrivacyGuard: ObservableObject {
    ...
    private func descriptionForFeature(_ feature: PrivacyFeature) -> String {
        switch feature {
        case .locationSharing:
            return "We use your location to provide navigation services and show your position on the map. Your location is processed locally on your device and only shared when you explicitly choose to share your ETA or enable friends on map."
        case .friendsOnMap:
            return "This feature allows you to see your friends' locations on the map and share your location with them. Both you and your friends must opt-in to this feature. You can disable this at any time."
        case .etaSharing:
            return "When you share your ETA, we send your current location and estimated arrival time to the people you choose. This information is only shared for the duration of your trip and is automatically deleted after 1 hour."
        case .analytics:
            return "We collect anonymous usage data to improve the app. This includes app crashes, feature usage, and performance metrics. No personal information or precise location data is collected."
        }
    }
    ...
    private func howToStopForFeature(_ feature: PrivacyFeature) -> String {
        switch feature {
        case .locationSharing:
            return "Go to Settings > Privacy > Location Services and disable location access for Shvil, or disable the panic switch to stop all sharing immediately."
        case .friendsOnMap:
            return "Go to Settings > Privacy > Friends on Map and disable this feature, or use the panic switch to stop all sharing immediately."
        case .etaSharing:
            return "Stop any active ETA sharing sessions in the app, or use the panic switch to immediately end all sharing."
        case .analytics:
            return "Go to Settings > Privacy > Analytics and disable this feature, or use the panic switch to stop all data collection."
        }
    }
}
